...
date: '2021-11-18'
tags: ['clojure', 'web', 'clojurescript']
lastmod: '2022-07-06'
draft: false
summary: ClojureScript의 React wrapper 라이브러리인 Reagent의 핵심 원리만 뽑아 간략하게 재구현하면서 그 구조를 설명한다.
---
...
![Clojurescript and React](/static/images/clojurescript-react.png)
</div>
...
## !!steps Step 1. JSX 대용으로 Hiccup 적용
...
## !!steps Step 4. Ratom을 이용한 상태 변경 지원
...
## !!steps Step 5. Local ratom을 위한 form-2 지원
